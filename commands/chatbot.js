...
const DEFAULT_PROMPT = 'You are Anonymous MD, a WhatsApp bot. Never mention queen raim. Keep replies concise.';
            ...
            try {
                await sendButtons(sock, chatId, {
                    ...
                    buttons: [
                        ...
                        { id: '.chatbot train', text: 'Train AI' },
